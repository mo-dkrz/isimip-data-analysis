...
for MODEL_PAIR in "${MODELS[@]}"; do
    ...
    for SCENARIO in "${SCENARIOS[@]}"; do
        ...
        # File patterns
        PR="${HIST_DIR}/${MODEL}_*_w5e5_historical_pr*.nc,${FUT_DIR}/${MODEL}_*_w5e5_${SCENARIO}_pr*.nc"
        TAS="${HIST_DIR}/${MODEL}_*_w5e5_historical_tas_*.nc,${FUT_DIR}/${MODEL}_*_w5e5_${SCENARIO}_tas_*.nc"
        TASMIN="${HIST_DIR}/${MODEL}_*_w5e5_historical_tasmin*.nc,${FUT_DIR}/${MODEL}_*_w5e5_${SCENARIO}_tasmin*.nc"
        TASMAX="${HIST_DIR}/${MODEL}_*_w5e5_historical_tasmax*.nc,${FUT_DIR}/${MODEL}_*_w5e5_${SCENARIO}_tasmax*.nc"
        HURS="${HIST_DIR}/${MODEL}_*_w5e5_historical_hurs*.nc,${FUT_DIR}/${MODEL}_*_w5e5_${SCENARIO}_hurs*.nc"
        RSDS="${HIST_DIR}/${MODEL}_*_w5e5_historical_rsds*.nc,${FUT_DIR}/${MODEL}_*_w5e5_${SCENARIO}_rsds*.nc"
        SFCWIND="${HIST_DIR}/${MODEL}_*_w5e5_historical_sfcwind*.nc,${FUT_DIR}/${MODEL}_*_w5e5_${SCENARIO}_sfcwind*.nc"
        PS="${HIST_DIR}/${MODEL}_*_w5e5_historical_ps*.nc,${FUT_DIR}/${MODEL}_*_w5e5_${SCENARIO}_ps*.nc"
